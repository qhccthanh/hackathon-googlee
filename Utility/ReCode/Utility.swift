...
class Utility {
    ...
    class func speakText(_ text: String) {
        
        let currentTime = Date().timeIntervalSinceReferenceDate
        let deltaTime = Date().timeIntervalSinceReferenceDate - currentTime
        if deltaTime < 5 {
            
            let voice = AVSpeechSynthesisVoice(language: voiceLangBCP)
...
//        SoundManager.playSpeakText(text, completion: {
//            let deltaTime = NSDate().timeIntervalSinceReferenceDate - currentTime
//            if deltaTime < 5 {
